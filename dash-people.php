                ...
                <a href="people-profile.php" style="text-decoration: none;color: black">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-5"><center><h3>
                            <font color="white"><b>All the citizen's can fill and update their profile over here for the official use.</b><br><br><br><br></font></h3></center>
                        </p>
                    </div>
                </a>
            </div>
                ...
                <a href="ngos-view.php" style="text-decoration: none;color: black">
                   <div class="card-body">
                        <h5 class="card-title">
                            <hr color="white">
                            <font color="white">
                                <center><b><h2>NGO'S LIST</h2></b></center>
                            </font>
                        </h5>
                        <hr color="white">
                        <p class="card-text mt-5"><center><h3>
                            <font color="white"><b>View all ngo's here...</b><br><br><br><br></font></h3></center>
                        </p>
                    </div>
                </a>
            </div>
                ...
                <a href="paypage.php" style="text-decoration: none;color: black">
                    <div class="card-body">
                        <h5 class="card-title">
                            <hr color="white">
                            <font color="white">
                                <center><b><h2>DONATE</h2></b></center>
                            </font>
                        </h5>
                        <hr color="white">
                        <p class="card-text mt-5"><center><h3>
                            <font color="white"><b>Donate to Ngo's</b><br><br><br><br></font></h3></center>
                        </p>
                    </div>
                </a>
            </div>
