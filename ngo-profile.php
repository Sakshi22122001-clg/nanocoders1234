...
<script>
    $(document).ready(function(){
        $("#FetchProfile").click(function() {
                var uid = $("#txtUid").val();
                var action_url = "ngos-fetch.php?uid=" + uid;
                ...
                $.getJSON(action_url, function(json_ary) {
                    ...
                    if (json_ary.length == 0) {
                        ...
                        $("#bio").hide().val(json_ary[0].bio).show(900);
...
<body style="background:#f0f0f0">
    <div class="container">
        ...
        <form action="ngo-process.php" method="post" enctype="multipart/form-data">
